...
from schemas.user import UserResponse, UserAvatarUpdate
...
def update_avatar(avatar_data: UserAvatarUpdate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
